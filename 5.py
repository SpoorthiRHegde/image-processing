...
import cv2
image=cv2.imread(r'C:\Users\Sahyadri\Pictures\Saved Pictures\ip1.webp',cv2.IMREAD_GRAYSCALE)
if image is None:
    raise FileNotFoundError("The  image file 'ip1.webp' was not found.")
